...
- When playing music, the system automatically selects the first search result.
...
VideoId, VideoUrl, Title, Channel = Result.id, Result.url, Result.title, Result.channel
